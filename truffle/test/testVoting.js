...
contract("Voting", function (accounts) {
  ...
  describe("when owner creates issues", function () {
    beforeEach(async function () {
      ...
      expectEvent(receiptCreateIssue1, "IssueCreated", {
        issueIndex: "0",
      ...
      expectEvent(receiptCreateIssue2, "IssueCreated", {
        issueIndex: "1",
